...
{
    private static readonly string filePath = "Assets/Resources/Data/Package.xls";
    private static readonly string exportPath = "Assets/Resources/Data/Package.json";
    private static readonly string[] sheetNames = { "PackageShop", };
    ...
    private static readonly string dataType = "Package";
    ...
    static void OnPostprocessAllAssets(string[] importedAssets, string[] deletedAssets, string[] movedAssets, string[] movedFromAssetPaths)
    {
        foreach (string asset in importedAssets)
        {
            ...
            PackageShopTable data = new PackageShopTable();
            ...
            using (FileStream stream = File.Open(filePath, FileMode.Open, FileAccess.Read))
            {
                ...
                foreach (string sheetName in sheetNames)
                {
                    ...
                    PackageShopTable.Sheet s = new PackageShopTable.Sheet();
                    s.name = sheetName;
                    ...
                    for (int i = 1; i < sheet.LastRowNum; i++)
                    {
                        ...
                        PackageShopTable.Param p = new PackageShopTable.Param();
