...
public class DiamondImporter : AssetPostprocessor {
	private static readonly string filePath = "Assets/Resources/Data/Diamond.xls";
	private static readonly string exportPath = "Assets/Resources/Data/Diamond.json";
	private static readonly string[] sheetNames = { "DiamondShop", };
    ...
    private static readonly string dataType = "Diamond";
	...
	static void OnPostprocessAllAssets (string[] importedAssets, string[] deletedAssets, string[] movedAssets, string[] movedFromAssetPaths)
	{
		foreach (string asset in importedAssets) {
			...
			DiamondShopTable data = new DiamondShopTable ();
			...
			using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read)) {
				...
				foreach(string sheetName in sheetNames) {
					...
					DiamondShopTable.Sheet s = new DiamondShopTable.Sheet ();
					s.name = sheetName;
					...
					for (int i=1; i< sheet.LastRowNum; i++) {
						...
						DiamondShopTable.Param p = new DiamondShopTable.Param ();
