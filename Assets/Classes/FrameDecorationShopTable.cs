...
public class FrameDecorationShopTable : ICloneable
{	
	public List<Sheet> sheets = new List<Sheet> ();
	
	public object Clone()
    {
        FrameDecorationShopTable clone = new FrameDecorationShopTable();
        clone.sheets.Clear();
	...
	public class Param : ICloneable
	{
		...
		public object Clone()
		{
          ...
          clone.ID = this.ID;
          clone.edgeName = this.edgeName;
          clone.priceICON = this.priceICON;
          clone.iconAtlas = this.iconAtlas;
          clone.edgeSprite = this.edgeSprite;
          clone.edgeAtlas = this.edgeAtlas;
